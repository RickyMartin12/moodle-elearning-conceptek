			    ...
			    for(var i=0; i< elem.length; i++)
			    {
			        ...
			        if (extension != "")
			        {
						switch(extension) {
							...
							case 'png':
							case 'gif':
								s_files += "<font id='fil_blog'><i class='fa fa-image'></i> <a href='https://moodle-elearning-conc.onrender.com/cat/"+elem[i]+"'><span>" + elem[i] + "</span></a> </font> ";
							break;                         
							case 'mp4':
							case 'mov':
							case 'vob':
							...
							case 'wmv':
							case 'm4v':
								s_files += "<font id='fil_blog'><i class='fas fa-film'></i> <a href='https://moodle-elearning-conc.onrender.com/cat/"+elem[i]+"'><span>" + elem[i] + "</span></a></font> ";
							break;
							default:
								s_files += "<font id='fil_blog'><i class='fas fa-file'></i><a href='https://moodle-elearning-conc.onrender.com/cat/"+elem[i]+"'><span>" + elem[i] + "</span></a></font> ";
							}
