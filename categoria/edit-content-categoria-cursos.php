			    ...
			    for(var i=0; i< elem.length; i++)
			    {
			        ...
			        if (extension != "")
			        {
						switch(extension) {
							...
							case 'png':
							case 'gif':
								s_files += "<font id='fil_blog'><i class='fa fa-image'></i> <a href='https://upload-moodle-test-cat-production.up.railway.app/cat/"+elem[i]+"'><span>" + elem[i] + "</span></a> </font> ";
							break;                         
							case 'mp4':
							case 'mov':
							case 'vob':
							...
							case 'wmv':
							case 'm4v':
								s_files += "<font id='fil_blog'><i class='fas fa-film'></i> <a href='https://upload-moodle-test-cat-production.up.railway.app/cat/"+elem[i]+"'><span>" + elem[i] + "</span></a></font> ";
							break;
							default:
								s_files += "<font id='fil_blog'><i class='fas fa-file'></i><a href='https://upload-moodle-test-cat-production.up.railway.app/cat/"+elem[i]+"'><span>" + elem[i] + "</span></a></font> ";
							}
